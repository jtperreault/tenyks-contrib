...
michigan_facts = [
        ...
        "Michigan State University is the largest institution of higher learning in the state and one of the largest universities in the country.",
        ...
        "Michigan State University was the first institution of higher learning in the nation to teach scientific agriculture.",
